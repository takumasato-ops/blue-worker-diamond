export interface Job {
  ...
  salaryRange: { min: number; max: number }; // 万円
  career: string;
  appeal: string[];
}
    ...
    jobs: [
      {
        id: "construction-mgr",
        title: "施工管理技士",
        image: "/images/construction-mgr.jpeg",
        tags: ["#高年収", "#管理職", "#需要急増"],
        certs: [
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        id: "truck-driver",
        title: "トラックドライバー",
        image: "/images/truck-driver.jpeg",
    ...
    jobs: [
      {
        id: "heavy-vehicle",
        title: "重機オペレーター",
        image: "/images/heavy-vehicle.jpeg",
        tags: ["#高需要", "#機械操作", "#災害復旧"],
        certs: [
      ...
      },
      {
        id: "special-vehicle",
        title: "大型特殊自動車",
        image: "/images/special-vehicle.jpeg",
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        id: "safety-officer",
        title: "衛生管理者・安全管理者",
        image: "/images/safety-officer.webp",
    ...
    jobs: [
      {
        ...
        title: "ビルメンテナンス",
        image: "/images/building-maintenance.jpeg",
